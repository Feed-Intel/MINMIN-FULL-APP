...
const RegisterScreen = () => {
  ...
  const handleRegister = () => {
    setIsSubmitted(true);
    if (
      !validator.isAlpha(user.full_name) ||
        ...
        >
          ...
          <View style={styles.inputContainer}>
            ...
            <TextInput
              ...
              cursorColor="#EE8429"
            />
            {isSubmitted && !validator.isAlpha(user.full_name) && (
              <Text style={styles.errorText}>{i18n.t('invalid_name')}</Text>
            )}
          </View>
          ...
          <View style={styles.inputContainer}>
            ...
            <TextInput
              ...
              cursorColor="#EE8429"
            />
            {isSubmitted && !validator.isEmail(user.email) && (
          ...
          <View style={styles.inputContainer}>
            ...
            {isSubmitted &&
              (!validator.isMobilePhone(user.phone) ||
                (user.phone.length != 10 && user.phone.length != 12) ||
                (!user.phone.startsWith('09') &&
                  !user.phone.startsWith('251'))) && (
                <Text style={styles.errorText}>
                  {i18n.t('invalid_phonenumber')}
                </Text>
              )}
          </View>
          ...
          <View style={styles.inputContainer}>
            ...
            <TextInput
              ...
              cursorColor="#EE8429"
            />
            {isSubmitted && !validator.isStrongPassword(user.password) && (
