...
__d(function (global, require, _$$_IMPORT_DEFAULT, _$$_IMPORT_ALL, module, exports, _dependencyMap) {
  ...
  async function GET(request) {
    if (!_constants.GOOGLE_CLIENT_ID) {
    ...
    if (internalClient === "google") {
      idpClientId = _constants.GOOGLE_CLIENT_ID;
    } else {
      return Response.json({
    ...
    const params = new URLSearchParams({
      ...
      redirect_uri: _constants.BASE_URL + "/api/auth/callback",
      response_type: "code",
      scope: url.searchParams.get("scope") || "identity",
      state: state,
      prompt: "select_account"
    });
    return Response.redirect(_constants.GOOGLE_AUTH_URL + "?" + params.toString());
  }
},3069,[1221]);
module.exports = __r(3069);