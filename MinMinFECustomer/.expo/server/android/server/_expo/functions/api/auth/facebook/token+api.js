...
__d(function (global, require, _$$_IMPORT_DEFAULT, _$$_IMPORT_ALL, module, exports, _dependencyMap) {
  ...
  async function POST(request) {
    ...
    const fbResponse = await fetch("https://graph.facebook.com/v22.0/oauth/access_token", {
      method: "POST",
      headers: {
        "Content-Type": "application/x-www-form-urlencoded"
      },
      body: new URLSearchParams({
        client_id: _constants.FACEBOOK_CLIENT_ID,
        client_secret: _constants.FACEBOOK_CLIENT_SECRET,
        redirect_uri: _constants.FACEBOOK_REDIRECT_URI,
        code: code
      })
    });
    ...
    const resp = await fetch(`${process.env.EXPO_PUBLIC_BACKEND_URL}/auth/social/facebook/`, {
      method: "POST",
      headers: {
