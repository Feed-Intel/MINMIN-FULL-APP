...
class UserSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        """
        Create a new user instance, handling password hashing and branch/restaurant
        credentials email.
        """
        
        validated_data.pop('skip_otp_signal', False)
        ...
        if user_type in ['branch', 'restaurant'] and not password:
