...
export default function AddComboDialog({ visible, onClose }: AddComboDialogProps) {
        ...
        <Dialog.Content>
          <ScrollView>
            ...
            {/* <Card style={[styles.card, styles.dataTable]}> */}
              <Card.Content>
                <DataTable>
                  <DataTable.Header style={{ borderBottomWidth: 1, borderColor: '#91B275' }}>
                    <DataTable.Title> <Text style={{ fontSize: 13, fontWeight: '400', color: '#40392B' }}>Menu Item</Text></DataTable.Title>
                    <DataTable.Title style={isSmallScreen && { paddingLeft: 6 }}>
                      <Text style={{ fontSize: 13, fontWeight: '400', color: '#40392B' }}>Qty</Text>
                    </DataTable.Title>
                    <DataTable.Title style={{ paddingLeft: 0 }}>
                      <Text style={{ fontSize: 13, fontWeight: '400', color: '#40392B' }}>Half?</Text>
                    </DataTable.Title>
                    <DataTable.Title style={{ paddingLeft: 0 }}>
                      <Text style={{ fontSize: 13, fontWeight: '400', color: '#40392B' }}>Actions</Text>
                    </DataTable.Title>
                  </DataTable.Header>
